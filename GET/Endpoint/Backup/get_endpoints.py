...
for k in range(len(tenant_classes)):
    ...
    for x in range(len(data_df['imdata'])):
        ...
        for n in range(len(data_df['imdata'][x]['fvCEp']['children'])):
            if data_df['imdata'][x]['fvCEp']['children'][n].get('fvRsCEpToPathEp') is not None:
                path_tmp = data_df['imdata'][x]['fvCEp']['children'][n]['fvRsCEpToPathEp']['attributes']['tDn']
        ...
        #LOOP FOR IP ADDRESS AND CONTRUCT ENDPOINT CLASS
                for i in range(len(data_df['imdata'][x]['fvCEp']['children'])):
                    if data_df['imdata'][x]['fvCEp']['children'][i].get('fvIp') is not None:
